      ...
      <form className="flex-col space-y-3 gap-1 w-12/12" onSubmit={handleSubmit}>
        <div className=" grid  grid-cols-3 space-x-4 ">
          ...
          <div>
            ...
            <Input value={PC_info.com_version} onChange={(e)=> setInfo({...PC_info , com_version:e.target.value})} className="border-[0.4px] border-gray-400"></Input>
          </div>
          <div>
            <label htmlFor="">OS Version</label>
            <Input value={PC_info.os_version} onChange={(e)=> setInfo({...PC_info , os_version:e.target.value})} className="border-[0.4px] border-gray-400"></Input>
          </div>
        </div>
        ...
        <div className="grid  grid-cols-3 space-x-4">
          ...
          <div>
            ...
            <Input value={PC_info.storage} onChange={(e)=> setInfo({...PC_info , storage:e.target.value})} className="border-[0.5px] border-gray-400"></Input>
          </div>
          <div>
            <label htmlFor="">Antivirus Status</label>
            <Select value={PC_info.ant_virus} onValueChange={(value:"Active" | "Expired" | "Expired-soon") => setInfo({...PC_info , ant_virus :value})}>
        ...
        <div className="grid grid-cols-1">
          ...
          <Input type="number" value={PC_info.days_remaining} onChange={(e)=> setInfo({...PC_info , days_remaining:Number(e.target.value)})} className="w-2/5 border-[0.5px] border-gray-400"></Input>
        </div>
