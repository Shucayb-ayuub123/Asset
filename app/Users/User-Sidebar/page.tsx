...
const page = ({ isOpen, onClose }: Props) => {
  ...
  const links = [
    { name: "Dashboard", href: "/Users", icons: LayoutDashboard },
    { name: "computers", href: "/Users/computer", icons: Monitor },
    { name: "printers", href: "/Users/printers", icons: PrinterIcon },
    { name: "other-devices", href: "/Users/other-devices", icons: Cpu },
  ];
  return (
    <div>
      ...
      <div
        className={`fixed top-0 left-0 h-screen w-64  bg-blue-950 z-50 transform transition-transform duration-300
